...
A continuación, se presenta una gráfica que permite comparar el comportamiento de los nodos en los diferentes escenarios y condiciones. En la gráfica, se observa cómo el número de nodos seguidores afecta la efectividad de la extinción de fuegos, tanto en la condición de control como en la experimental. Pero también se puede observar que la condición experimental mejora el número de fuegos extinguidos en todos los escenarios, especialmente en el escenario 3, donde la diferencia es notable.
\begin{figure}[H]
    \centering
