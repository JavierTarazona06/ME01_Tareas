...
\begin{table}[H]
\centering
\caption{Comparación de resultados simulados vs. teóricos para diferentes escenarios M/M/1}
\label{tab:mm1-resultados-todos}
\resizebox{\textwidth}{!}{%
\begin{tabular}{ccccccccccc}
\toprule
\textbf{Clientes} & \textbf{$\lambda$} & \textbf{$\mu$} & \textbf{$W_q$ sim} & \textbf{$W_q$ teórico} & \textbf{Error $W_q$ (\%)} & \textbf{$L_q$ sim} & \textbf{$L_q$ teórico} & \textbf{Error $L_q$ (\%)} & \textbf{$\rho$ sim} & \textbf{$\rho$ teórico} \\
\midrule
500  & 0.127 & 0.208 & 6.193  & 8.3333  & 25.97  & 0.782  & 1.0417 & 24.10  & 0.602  & 0.625 \\
1000 & 0.125 & 0.205 & 8.015  & 8.3333  & 3.18   & 1.001  & 1.0417 & 4.07   & 0.608  & 0.625 \\
1000 & 0.117 & 0.158 & 16.346 & 49.0000 & 66.65  & 1.904  & 6.1250 & 68.91  & 0.735  & 0.875 \\
1000 & 0.097 & 0.210 & 4.300  & 5.0000  & 14.00  & 0.418  & 0.5000 & 16.40  & 0.460  & 0.500 \\
1000 & 0.099 & 0.147 & 16.018 & 16.3333 & 1.93   & 1.593  & 1.6333 & 2.46   & 0.674  & 0.700 \\
1000 & 0.049 & 0.207 & 1.753  & 1.6667  & 5.20   & 0.087  & 0.0833 & 4.44   & 0.237  & 0.250 \\
1000 & 0.050 & 0.147 & 3.850  & 3.7692  & 2.14   & 0.192  & 0.1885 & 1.86   & 0.339  & 0.350 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\paragraph{Convergencia y Validación}
Los resultados muestran que, al aumentar el número de clientes, los valores simulados convergen hacia los valores teóricos del modelo M/M/1. Por ejemplo, en el paso de 500 a 1000 clientes con la misma configuración, el error relativo en $W_q$ se reduce significativamente (de 25.97\% a 3.18\%).
