...
\begin{enumerate}
  ...
  \item \textbf{Creación de la clase:} Se registra la asignación como un nuevo diccionario en 
        ...
        \begin{itemize}
          \item \texttt{codigo\_clase} (int)
          \item \texttt{codigo\_curso} (int): código del curso asociado
          \item \texttt{cedula\_docente} (int): código del docente asociado
          \item \texttt{horario} (Tuple[str, str]): horario asociado Dia: str, franja Horaria: str.
          \item \texttt{edificio+aula\_id} (str): aula asociada
          \item \texttt{grupo} (int): búmero de grupo
