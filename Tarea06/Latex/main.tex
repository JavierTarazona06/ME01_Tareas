...
\noindent Se observa que el \textbf{Escenario 2} presenta los mejores resultados en varias métricas clave. En términos de \textit{satisfacción media}, alcanza un valor de 0.659, el más alto entre los escenarios, lo cual indica que una mayor proporción de estudiantes recibió cursos cercanos a sus primeras opciones de preferencia. En cuanto al \textit{uso de cupos}, este escenario también sobresale con una tasa de ocupación del 74.2\%, lo que refleja una asignación más eficiente de los recursos disponibles.
Respecto al \textit{porcentaje de asignación a las tres primeras opciones}, el Escenario 2 obtiene los valores más altos en segunda (53.16\%) y tercera opción (35.19\%), y en la métrica compuesta ``alguna de las tres'' (16.89\%), superando a los demás escenarios. Esto indica una mayor capacidad del sistema para ubicar a los estudiantes dentro de sus preferencias, incluso si no se trata de su primera elección.
Además, este escenario presenta la mayor \textit{eficiencia de Pareto} con un valor de 0.0712, lo que significa que la proporción de asignaciones que no pueden mejorarse para un estudiante sin empeorar la de otro es mayor, reflejando una mayor eficiencia global en la distribución.
Por otro lado, el \textbf{Escenario 3} destaca por tener la mejor puntuación en \textit{equidad} (0.221), lo que sugiere que las diferencias entre los estudiantes en términos de satisfacción fueron menores y, por tanto, la asignación fue más justa desde el punto de vista distributivo. Sin embargo, esta mejora en equidad se obtuvo a costa de una notable disminución en las demás métricas: la satisfacción media cayó a 0.533, el uso de cupos bajó a 59.8\%, y la eficiencia de Pareto se redujo significativamente a 0.0182. Asimismo, solo el 66\% de los estudiantes obtuvo su primera opción, en contraste con más del 99\% en los otros escenarios. Esta caída indica que aunque el reparto fue más equitativo, el sistema no logró complacer las preferencias individuales de la mayoría de los estudiantes.
En resumen, mientras el Escenario 2 ofrece una solución balanceada con altos niveles de satisfacción, eficiencia y aprovechamiento de recursos, el Escenario 3 prioriza la equidad a costa del rendimiento general del sistema.
